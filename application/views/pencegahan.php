    ...
    <div class="card text-center">
      <div class="card-header bg-light">
          <ul class="nav nav-pills container">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="<?php echo site_url('pencegahan/')?>">Pencegahan</a>
            </li>
            <li class="nav-item">
      ...
      <div class="card-body">
        ...
        <div class="jumbotron jumbotron-fluid">
          <div class="container">
            ...
            <p class="lead">REDUCE YOUR RISK OF COVID-19 INFECTION</p>
          </div>
        </div>

        <div class="card-deck">
          <div class="card">
            <img src="<?php echo base_url('assets/img/1.JPEG'); ?>" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Tidak Mudik</h5>
              
            </div>
          </div>

          <div class="card">
            <img src="<?php echo base_url('assets/img/2.JPEG'); ?>" class="card-img-top" alt="...">
            <div class="card-body">
          ...
          <div class="card">
            <img src="<?php echo base_url('assets/img/3.JPEG'); ?>" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Makan yang Bergizi</h5>
          ...
          <!-- ----------------------------- -->
          <div class="card">
            <img src="<?php echo base_url('assets/img/4.JPEG'); ?>" class="card-img-top" alt="...">
            <div class="card-body">
          ...
          <div class="card">
            <img src="<?php echo base_url('assets/img/5.JPEG'); ?>" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Penggunaan Disinfektan</h5>
              
            </div>
          </div>

          <div class="card">
            <img src="<?php echo base_url('assets/img/6.JPEG'); ?>" class="card-img-top" alt="...">
            <div class="card-body">
              <h5 class="card-title">Di Rumah Saja</h5>
